...
const skills = [
    ...
    , {name: "Prometheus", level: 55, category: "DevOps"}
    ...
    return <section 
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-12">
                    {categories.map((category, key) => (
                        <button 
                            ...
                            className={cn(
                                "px-5 py-2 rounded-full transition-colors duration-500 capitalize hover:cursor-pointer",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredSkills.map((skill, key) => (
                        <div key={key} className="bg-card p-6 rounded-lg shadow-xs card-hover transition-opacity duration-500 hover:shadow-md">
